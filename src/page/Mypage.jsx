...
const MyPage = () => {
  ...
  const handleLogout = () => {
    ...
    window.dispatchEvent(new Event('storage')); // Home.jsx에 알림
    navigate('/'); // 메인 화면으로 즉시 이동
  };
  ...
  return (
    <div className="mypage-container">
      ...
      <div className="mypage-footer-buttons">
        <Link to="/" className="mypage-return-button link-button" >
          메뉴로 돌아가기
        </Link>
        <button onClick={handleLogout} className="mypage-return-button logout-button" >
          로그아웃
        </button>
      </div>
